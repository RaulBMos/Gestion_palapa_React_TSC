...
import { SuspenseWrapper } from '@/components/templates/SuspenseWrapper';
import { BarChartSkeleton, PieChartSkeleton } from '@/components/molecules/ChartSkeletons';
import { AIPanelSkeleton } from '@/components/molecules/AIPanelSkeleton';
...
const MonthlyFlowChart = lazy(() => import('@/components/molecules/DashboardCharts').then(m => ({ default: m.MonthlyFlowChart })));
const ExpenseCategoryChart = lazy(() => import('@/components/molecules/DashboardCharts').then(m => ({ default: m.ExpenseCategoryChart })));

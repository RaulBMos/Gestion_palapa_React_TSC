    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="bg-slate-100 p-1 rounded-xl flex">
        <button 
          ...
          className={`flex-1 py-2 rounded-lg text-sm font-semibold transition-all flex items-center justify-center gap-2 ${
            activeTab === TransactionType.INCOME ? 'bg-white text-emerald-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'
          }`}
        >
        ...
        <button 
          ...
          className={`flex-1 py-2 rounded-lg text-sm font-semibold transition-all flex items-center justify-center gap-2 ${
            activeTab === TransactionType.EXPENSE ? 'bg-white text-red-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'
          }`}
        >
      ...
      <div className="flex justify-end">
        <button 
          ...
          className={`${
            activeTab === TransactionType.INCOME ? 'bg-emerald-600 hover:bg-emerald-700' : 'bg-red-600 hover:bg-red-700'
          ...
          <div className="bg-white rounded-2xl w-full max-w-md p-6 shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex gap-3 mt-6">
                ...
                <button 
                  type="submit" 
                  className={`flex-1 py-3 text-white font-semibold rounded-xl shadow-lg ${
                    activeTab === TransactionType.INCOME ? 'bg-emerald-600 hover:bg-emerald-700 shadow-emerald-200' : 'bg-red-600 hover:bg-red-700 shadow-red-200'
                  }`}
                >

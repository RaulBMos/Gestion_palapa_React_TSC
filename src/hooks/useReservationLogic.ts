...
import {
  ...
  ReservationStatus,
  Client,
  CalendarState as BaseCalendarState,
...
interface ReservationLogicHookReturn extends ReservationCalendarHelpers {
  // Estado
...
export const useReservationLogic = (
  ...
  const getClientName = useCallback((id: string, clientsList?: Client[]) => {
    const clientList = clientsList || clients;

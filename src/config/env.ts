...
function validateEnv() {
  try {
    const env = envSchema.parse({
      VITE_SERVER_URL: (import.meta as any).env?.VITE_SERVER_URL,
      VITE_GEMINI_API_KEY: (import.meta as any).env?.VITE_GEMINI_API_KEY,
      VITE_API_URL: (import.meta as any).env?.VITE_API_URL,
      VITE_ENCRYPTION_KEY: (import.meta as any).env?.VITE_ENCRYPTION_KEY,
      VITE_MODE: (import.meta as any).env?.MODE,
      VITE_DEBUG: (import.meta as any).env?.VITE_DEBUG,
      VITE_BASE_URL: (import.meta as any).env?.BASE_URL,
    });
